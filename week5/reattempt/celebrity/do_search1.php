...
<body>
    ...
    <?php
        ...
        foreach($persons_one as $line){
            if (strpos(strtolower($line), $surname)){
                echo "$line <br>";
            }
        }
...
//'Kendall Kardashian Jenner (Female), Celebrity #600'
    ...
    <?php
        // Your Code Goes Here
        foreach($persons_three as $person=>$info){
            if(strpos(strtolower($person), $surname)){
                echo "$person </br>";
            }
        }
    ...
    <table border='1'>
        ...
        <?php
        // Your Code Goes Here
        foreach($persons_three as $name=>$info){
            if(strpos(strtolower($name),$surname)){
                echo "<tr>
    ...
    <?php
        ...
        foreach($persons_four as $person=>$info){
