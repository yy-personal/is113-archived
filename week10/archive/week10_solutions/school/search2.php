...
if( isset($_POST['submit_search']) ) {
    ...
    $courseArray = $dao->getCourse2($term, $credit);
}
...
<form action='search2.php' method='POST'>
    ...
    Term:
    <label>
        <input type='checkbox' name='term[]' value='1'> 1
    </label>
    <label>
        <input type='checkbox' name='term[]' value='2'> 2
    </label>
    ...
    Credit:
    <label>
        <input type='checkbox' name='credit[]' value='2'> 2
    </label>
    <label>
        <input type='checkbox' name='credit[]' value='3'> 3
    </label>
